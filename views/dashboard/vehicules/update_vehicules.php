<form method="post" enctype="multipart/form-data">
    <label for="id_type" class="border rounded-3 p-1 white">Catégorie</label>
    ...
    <label for="brand" class="border rounded-3 p-1 white mt-3">Marque du véhicule</label>
    ...
    <div class="form-check">
        <label class="form-check-label border rounded-3 p-1 white" for="deleteImg">
            Supprimer l'image
        </label>
        <input class="form-check-input " type="checkbox" name="deleteImg" id="deleteImg">
    </div>
    <p><?= $errors['picture'] ?? '' ?></p>
